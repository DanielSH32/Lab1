...
//print_r($suma);
echo "<h1>La suma de {$parametros["intA"]} mas {$parametros["intB"]} es {$suma["AddResult"]}</h1>";

$resta=$cliente->call('Subtract',$parametros);
echo "<h1>La resta de {$parametros["intA"]} menos {$parametros["intB"]} es {$resta["SubtractResult"]}</h1>";
